# -*- coding: utf-8 -*-
"""olist dashboard.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1U6VsA8QXgur6tJh4PHQL5yMrvsnnJzyW
"""
...
with st.sidebar:
    st.title("Biodata:")
    st.markdown("**• Nama: Aditya Candra Gumilang**")
...
# Title
st.header("Olist E-Commerce Dashboard :convenience_store:")
...
tab1, tab2, tab3, tab4, tab5 = st.tabs(["Champion", "Cant Lose Them", "Need Attention", "About to Sleep","Lost Customer"])

with tab1:
    st.write(" Melakukan pembelian dalam waktu dekat, terus menerus, dan mengeluarkan banyak uang, Mereka adalah top custemer yang mendukung perusahaan. Hubungan baik antar Olist dan kelompok customer ini perlu dijaga agar tetap terjalin dengan baik.")
    st.write("Direkomendasikan untuk cluster ini sebagai berikut :")
    st.markdown(
...
with tab3:
    st.write("Melakukan pembelian, menghabiskan uang, dan menggunakan Olist diatas rata-rata tetapi tidak terlalu besar, Kelompok ini membutuhkan tindakan agar mereka dapat merasakan bahwa perusahaan (Olist) dapat menawarkan kondisi terbaik dan memenuhi semua harapan mereka.")
    st.write("Direkomendasikan untuk cluster ini sebagai berikut :")
    st.markdown(
    "**• Melakukan kampanye dan memilih Brand ambasador yang kuat untuk mendapatkan perhatian dan kepercayaan pelanggan.**")
    st.markdown(
...
with tab4:
    st.write("Melakukan pembelian, menghabiskan uang, dan menggunakan Olist dibawah rata-rata tetapi masih aktif, Grup ini penting diperhatikan karena masih adanya potensi pembelian dari kelompok customer ini.")
    st.write("Direkomendasikan untuk cluster ini sebagai berikut :")
    st.markdown(
    "**• Menawarkan voucer promo terbatas.**")
    st.markdown(
    "**• Menawarkan voucer potongan harga dengan minimal transaksi.**")
    st.markdown(
    "**• Memberikan push notification dan broadcast message untuk menarik perhatian.**")

with tab5:
    st.write("Customer yang memiliki nilai rfm terkecil, dianggap customer yang churn..")
    st.write("Direkomendasikan untuk cluster ini sebagai berikut :")
    st.markdown(
    "**• Menawarkan program loyalitas atau voucher diskon.**")
    st.markdown(
    "**• Memberikan pesan personal dengan sifat persuasif dengan penawaran promo spesial atau khusus untuk cluster tersebut.**")
    st.markdown(
    "**• Kampanye promosi dengan waktu yang terbatas, untuk menciptakan sensasi yang tidak dapat dilewatkan.**")

st.caption('Copyright (C) Aditya Candra Gumilang 2023')